...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta property="og:title" content="Gun Display Page">
...
?>
  ...
  <h1 class="u-custom-font u-font-merriweather u-text u-text-default u-text-1">CODT<span class="u-text-custom-color-2"></span>OPIA
      ...
      <?php
        ...
        echo'<h1 style="text-align: center" style="margin:50px" style:"padding: 40px">Guns</h4>';
      ...
      while ($row = $result1->fetch_assoc()){
        ...
        $query = "SELECT * FROM GUNS WHERE GUN_UNLOCK_LEVEL = $idLevel";
        ...
        while ($row = $result->fetch_assoc()){
          ...
          echo '<section class="u-clearfix u-custom-color-2 u-section-1" id="sec-36ba" >';
          echo'<div class="u-clearfix u-sheet ">';
          ...
          echo'<div  class="u-black  u-radius-50 u-shape-round  " style = "height:120px">';
          echo'<div class="u-border-6 u-border-white u-container-layout  " >';
          echo'<h4 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-1">Gun: '.$row['GUN_NAME'].'</h4>';
          echo'<h2 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-2">Unlock Level: '.$row['GUN_UNLOCK_LEVEL'].'</h2>';
          echo '</p>';
...
<?php
        ...
        echo '<br>';
          ...
          echo'<h1 style="text-align: center">Perks</h4>';
        ...
        $query = "SELECT * FROM PERKS WHERE PERK_UNLOCK_LEVEL = $idLevel";
        $result= mysqli_query($conn, $query);
        ...
        while ($row = $result->fetch_assoc()){
          ...
          echo'<div  class="u-black  u-radius-50 u-shape-round  " style = "height:120px">';
          echo'<div class="u-border-6 u-border-white u-container-layout  " >';
          echo'<h4 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-1">Perk: '.$row['PERK_NAME'].'</h4>';
          echo'<h2 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-2">Unlock Level: '.$row['PERK_UNLOCK_LEVEL'].'</h2>';
          echo '</p>';
...
<?php
        ...
        echo '<br>';
          ...
          echo'<h1 style="text-align: center">Equipment</h4>';
        ...
        $query = "SELECT * FROM EQUIPMENT WHERE EQ_UNLOCK_LEVEL = $idLevel";
        $result= mysqli_query($conn, $query);
        ...
        while ($row = $result->fetch_assoc()){
          ...
          echo'<div  class="u-black  u-radius-50 u-shape-round  " style = "height:120px">';
          echo'<div class="u-border-6 u-border-white u-container-layout  " >';
          echo'<h4 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-1">Perk: '.$row['EQ_NAME'].'</h4>';
          echo'<h2 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-2">Unlock Level: '.$row['EQ_UNLOCK_LEVEL'].'</h2>';
          echo '</p>';
...
<?php
        ...
        $query = "SELECT * FROM FIELD_UPGRADES WHERE FU_UNLOCK_LEVEL = $idLevel";
        $result= mysqli_query($conn, $query);
        ...
        while ($row = $result->fetch_assoc()){
          ...
          echo'<div  class="u-black  u-radius-50 u-shape-round  " style = "height:120px">';
          echo'<div class="u-border-6 u-border-white u-container-layout  " >';
          echo'<h4 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-1">Perk: '.$row['FU_NAME'].'</h4>';
          echo'<h2 class="u-align-center u-text u-text-custom-color-2 u-text-default u-text-2">Unlock Level: '.$row['FU_UNLOCK_LEVEL'].'</h2>';
          echo '</p>';
